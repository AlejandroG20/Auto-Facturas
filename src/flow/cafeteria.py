...
def flujo_cafeteria(numero: int, logger: logging.Logger, stop_event: threading.Event) -> None:
    """Introduce el número y la referencia siguiendo la secuencia de Cafetería."""
